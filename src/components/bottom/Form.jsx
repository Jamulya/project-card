...
import CardHolderNumber from './form/CardHolderName'
...
const Form = ({ recordName, recordNumber, recordMonth, recordYear, recordCvc}) => {
...
const {register, handleSubmit, formState: {errors}} = useForm({defaultValues: {
  ...
  return (
    <div id='formContainer'>
      <form noValidate onSubmit={handleSubmit(onSubmit)} className='w-full flex flex-col items-start' >
        ...
        <div id='expCvcWrapper' className='w-full mb-7'>
